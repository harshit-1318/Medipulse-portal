...
const DEFAULT_FILTERS: OrderFilters = {
    ...
    category: "asthma",
    productCategory: "asthma",
};

export function useAsthmaOrdersData() {
    const storageKey = getDashboardStorageKey("asthma");
    ...
    useEffect(() => {
        ...
        getOrders(page, apiFilters).then((res) => {
            ...
            if (!ignore) stopLoader("asthma-orders");
        });
