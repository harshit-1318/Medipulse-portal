...
const DEFAULT_FILTERS: OrderFilters = {
    ...
    category: "joint-pain",
    productCategory: "joint-pain",
};

export function useJointPainOrdersData() {
    const storageKey = getDashboardStorageKey("joint-pain");
    ...
    useEffect(() => {
        ...
        getOrders(page, apiFilters).then((res) => {
            ...
            if (!ignore) stopLoader("joint-pain-orders");
        });
