...
const DEFAULT_FILTERS: OrderFilters = {
    ...
    category: "migraine",
    productCategory: "migraine",
};

export function useMigraineOrdersData() {
    const storageKey = getDashboardStorageKey("migraine");
    ...
    useEffect(() => {
        ...
        getOrders(page, apiFilters).then((res) => {
            ...
            if (!ignore) stopLoader("migraine-orders");
        });
