...
const DEFAULT_FILTERS: OrderFilters = {
    ...
    startDate: "",
    endDate: "",
    repeatedOrders: "first",
    isUrgent: false,
    sortBy: "shopify_order_id",
    sort: "desc",
};

export function useFirstOrdersData() {
    const storageKey = getDashboardStorageKey("first");
    ...
    // This logic handles direct links from customer directory
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        getOrders(page, apiFilters).then((res) => {
            ...
            if (!ignore) stopLoader("first-orders");
        });
