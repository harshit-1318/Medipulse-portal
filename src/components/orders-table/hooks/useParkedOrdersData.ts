...
const DEFAULT_FILTERS: OrderFilters = {
    ...
    isParked: true, // DEFAULT TO TRUE FOR PARKED ORDERS PAGE
};

export function useParkedOrdersData() {
    const storageKey = getDashboardStorageKey("parked");
    ...
    useEffect(() => {
        ...
        getOrders(page, filters).then((res) => {
            ...
            if (!ignore) stopLoader("parked-orders");
        });
