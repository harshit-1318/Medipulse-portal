...
import { StoreCredentialsFields } from "./StoreCredentialsFields";
...
export const StoreSettingsSection: React.FC<Props> = ({ form, handleChange }) => {
    ...
    return (
        <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden h-full flex flex-col">
            <div className="p-5 border-b border-slate-100 bg-slate-50/30 flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-slate-800 tracking-tight">Store Integration</h3>
            </div>
